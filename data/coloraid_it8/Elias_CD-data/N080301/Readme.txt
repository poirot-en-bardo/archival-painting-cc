...
- The ANSI IT 8.7/1 target is for use with the latest Fujichrome
  Velvia 100, 100F, Provia 400X and Astia 100F films.
  The target can also be used with Sensia 100 films produced
  since June 2003 (emulsion 687 and higher).
  
  The target should not be used with Sensia 100 films produced
  before June 2003 or having an emulsion number below 651.
  The target is not for use with older Astia, Provia, Sensia or
  other film types.
...
- This floppy or CD does contain the IT 8.7/1 reference file(s) for the
  calibration target charge "N080301". Make sure that the charge printed on 
  your target slide frame does match the reference file. For instance, 
  choose the file "N080301.txt" in your profiling software if the charge 
  printed on the slide frame is "N080301".
...
- Always protect the calibration slide from strong light.
  ...
  specific film used (Velvia 100F for this target).
...
- The "Extras" directory does contain additional files for your
  ...
  N080301S.txt :  A smaller version of the normal reference file not
  ...
  N080301.eps  :  This file is for use with the X-Rite ColorShop V2 program
  ...
  N080301.xls :   A tab delimited file that loads nicely into the Excel
  ...
  N080301.cgt :   This file does contain the spectral data of the targets
  ...
  N080301.cxf :   This CxF formated file does contain the spectral data of 
