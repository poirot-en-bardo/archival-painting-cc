...
- The ANSI IT 8.7/1 target is for use with the old and renewed
  Fujichrome Velvia RVP 50 film. The target is not for use with
  the newer Velvia 100/100F film. Using the wrong film type
  usualy does result in visible color faults.

- This floppy or CD does contain the IT 8.7/1 reference file(s) for the
  calibration target charge "V090119". Make sure that the charge printed on 
  your target slide frame does match the reference file. For instance, 
  choose the file "V090119.txt" in your profiling software if the charge 
  printed on the slide frame is "V090119".
...
- Always protect the calibration slide from strong light.
  ...
  specific film used (Velvia 50 for this target).
...
- The "Extras" directory does contain additional files for your
  ...
  V090119S.txt :  A smaller version of the normal reference file not
  ...
  V090119.eps  :  This file is for use with the X-Rite ColorShop V2 program
  ...
  V090119.xls :   A tab delimited file that loads nicely into the Excel
  ...
  V090119.cgt :   This file does contain the spectral data of the targets
  ...
  V090119.cxf :   This CxF formated file does contain the spectral data of 
