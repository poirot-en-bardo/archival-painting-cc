...
- The ANSI IT 8.7/1 target is for use with the Kodak Ektachrome
  films. Using other films usualy does result in
  visible color faults.

- This floppy or CD does contain the IT 8.7/1 reference file(s) for the
  calibration target charge "E080515". Make sure that the charge printed on 
  your target slide frame does match the reference file. For instance, 
  choose the file "E080515.txt" in your profiling software if the charge 
  printed on the slide frame is "E080515".
...
- The colors of the target will change with time.  It is recommended
  ...
  quality loss. The recommended lifetime can be extended for uncritical
  work and if the target is handled with care.
...
- The "Extras" directory does contain additional files for your
  ...
  E080515S.txt :  A smaller version of the normal reference file not
  ...
  E080515.eps  :  This file is for use with the X-Rite ColorShop V2 program
  ...
  E080515.xls :   A tab delimited file that loads nicely into the Excel
  ...
  E080515.cgt :   This file does contain the spectral data of the targets
  ...
  E080515.cxf :   This CxF formated file does contain the spectral data of 
  ...
  Fault.txt    :  Some technical info on the color faults of the targets.
                  See also the statistical info saved in the normal
                  reference file.
