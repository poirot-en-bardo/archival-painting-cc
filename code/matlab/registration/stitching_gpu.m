...
for bandIdx = 1:nBands
    ...
    stitched_cube(:,:,bandIdx) = gather(out);
...
% %% Visualisation
% stitched_thresholded = stitched_cube;
% %
% % Clip values above a certain threshold 
% threshold = 1;  % Set an appropriate threshold based on your data
...
destFolder = '../../../../data/processed/reflectance/before';  
...
%% Flatten spatial dims to N×B for matrix math
[rows, cols, B] = size(stitched_thresholded);
linCube = double( reshape(stitched_thresholded, rows*cols, B) );  
