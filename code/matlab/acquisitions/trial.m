...
% INPUTS
ref_mat = '/home/oem/eliza/mac-shared/registered_hyper/yoda_after_data2_1.mat';
...
% Crop the same region from reference
ref_rgb_prophoto = imcrop(ref_img, bbox);
